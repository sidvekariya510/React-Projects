                    ...
                    <div className="overlay container">
                        <div className="innercontainer container-fluid">
                            <div className="row banner d-flex justify-content-center text-light gx-0">
                                ...
                                {/* <!-- Heading --> */}
                                <div className="h3 brand fw-bold col-xl-2 col-lg-3 col-sm-4 col-6 text-md-start text-sm-start text-center text-warning">
                                    {props.brand}</div>

                                {/* <!-- menu button --> */}
                                <div className="h3 menu d-lg-none d-sm-flex justify-content-sm-end col-xl-9 col-lg-9 col-sm-8 col-6 text-end">
                                ...
                                <div className="collapse" id="collapseExample">
                                    <div className="card card-body text-center list-unstyled bg-dark bg-gradient">
                                        <li><Link className="dropdown-item fs-6 text-warning" to="/Home">Home</Link></li>
                                        <li><Link className="dropdown-item fs-6 text-warning" to="/AboutUs">About Us</Link></li>
                                        <li><Link className="dropdown-item fs-6 text-warning" to="/Services">Services</Link></li>
                                        <li><Link className="dropdown-item fs-6 text-warning" to="/Gallery">Gallery</Link></li>
                                        <li><Link className="dropdown-item fs-6 text-warning" to="/Contact">Contact</Link></li>
                                        <li><Link className="dropdown-item fs-6 text-light" to="/Contact">
                                    ...
                                    <div className="col-lg-7 col-sm-12 pt-lg-0 pt-sm-5">
                                        <div className="right row text-light text-center">
                                            ...
                                            <div className="col-sm-4">
                                                ...
                                                <i className="fa-solid fa-file-contract border border-1 rounded-circle bg-light text-dark p-3"></i>
                                            </div>e
                                        </div>
                                    </div>
                                </div>
