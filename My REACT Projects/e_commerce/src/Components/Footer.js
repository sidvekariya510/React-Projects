                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4  col-md-6 col-sm-6">
                            <div className="single-footer-widget">
                                <h6>Newsletter</h6>
                                <p className=''>Stay update with our latest</p>
                                <div className="">
                        ...
                        <div className="footer-bottom d-flex justify-content-center flex-wrap">
                            <p className="footer-text fs-4 text-center">
                                <p className='text-dark mt-5 pt-5'>
                                    <a className='px-1 text-uppercase' href="#">I N F I N I T Y</a>
